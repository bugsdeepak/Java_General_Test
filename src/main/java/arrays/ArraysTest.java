...
/**
 * In Java, main.java.arrays are objects, are dynamically created, and may be assigned to variables of type Object.
...
public class ArraysTest {
	...
	public static void main(String[] args) {
		...
		if(intArray1.equals(intArray2)){
			...
			System.out.println("Merely calling the equals on main.java.arrays will not have correct result");
		}
		
		if(Arrays.equals(intArray1, intArray2)) {
			System.out.println("Use the Arrays class to compare two main.java.arrays");
		}
