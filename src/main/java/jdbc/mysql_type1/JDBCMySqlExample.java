package main.java.jdbc.mysql_type1;
...
public class JDBCMySqlExample {
    ...
    private static String connectionUrl = "main.java.jdbc:odbc:test";
    private static String userName = "root";
    private static String password = "deepak";
    
    public static String driverClassName = "sun.main.java.jdbc.odbc.JdbcOdbcDriver";
