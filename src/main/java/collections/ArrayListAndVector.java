...
public class ArrayListAndVector {
	...
	public static void main(String[] args) {
        ...
        System.out.println("The Integer Objects' main.java.hashcode : " + i.hashCode());
        
        //the equals and main.java.hashcode mtheods are overridden for the entire collection.
        ...
        if(list.equals(vector)) {
            ...
            System.out.println("ArrayList's main.java.hashcode : " + list.hashCode());
            System.out.println("Vector's main.java.hashcode : " + vector.hashCode());
        }
        
        if(ll.equals(list)) {
            System.out.println("ArrayList and LinkedList are equal");
            System.out.println("ArrayList's main.java.hashcode : " + list.hashCode());
            System.out.println("LinkedList's main.java.hashcode : " + ll.hashCode());
        }
