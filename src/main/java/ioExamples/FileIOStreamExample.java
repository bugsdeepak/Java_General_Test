...
public class FileIOStreamExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //the following line will not throw any main.java.exception,
        ...
        try {
            ...
            //the below loop does not throw any main.java.exception. Even after the EOF
            //is reached if you still call read() before close() you get the
            //same value -1, but no main.java.exception
            for(int i=65; i <= 90; i++ ) {
