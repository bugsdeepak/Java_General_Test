...
public class MessageFormatTest {
	...
	public void printFormattedString() {
		try {
			...
			System.out.println("Format = " + MessageFormat.format("This error happened in {0} and main.java.exception : {1}", args1));
			System.out.println("Format = This error happened in " + this.getClass().getName() + " and main.java.exception : " + ex );
			//ex.printStackTrace();
		}
	}
