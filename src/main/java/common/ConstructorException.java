...
public class ConstructorException {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if(obj2 == null) {
				System.out.println("On main.java.exception in Constructor, object is not all constructed");
			} else {
				System.out.println("On main.java.exception in Constructoer, object is constructed");
				obj2.printValues();
			}
