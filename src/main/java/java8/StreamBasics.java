...
/**
 * Streams offer performance advantages primarily through their ability to leverage parallel processing, lazy evaluation, and a declarative style, which can significantly improve the speed of data manipulation, especially when dealing with large datasets, by allowing efficient utilization of multi-main.java.core processors and minimizing unnecessary computations.
...
public class StreamBasics {
	...
	// LAMBDA Expressions are brought for using the internal Iterations and Make use of Multi main.java.core technologies
	...
	//            parallel streams for multi threaded / main.java.core operations
	...
	* ALL the Intermediate operations result another stream */
	...
	public static void main(String[] args) {
		...
		//File stream
		try {
			Stream<String> companies = Files.lines(Paths.get("src/main.java.java8/companies.txt"));
