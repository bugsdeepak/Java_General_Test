...
public class ClassConstants {
    ...
    public static void main(String[] args) {
        ...
        //the int arrays are intitalized to zeros
        int arr[] = new int[4];        
        ...
        //as an argument and we dont have the set of arrays - we have only
        //empty array and we dont want any exception to be thrown by the method
    }
}
